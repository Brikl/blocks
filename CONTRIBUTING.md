...
We also welcome pull requests from unaffiliated contributors. The [issue tracker](https://github.com/Brikl/blocks/issues) should provide plenty of issues that you can work on; we also mark issues that we think would be good for newcomers with the [`good first issue`](https://github.com/Brikl/blocks/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) label.
